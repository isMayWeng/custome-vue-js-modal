<template>
    ...
    Vue.use(vmodal)
        ...
        <div style="margin-top: 20px; margin-bottom: 15px;">
            <button
                    class="btn"
                    @click="show(false, false, false)">Simple
            </button>
            <button
                    class="btn"
                    @click="show(true, false, false)">Resizable
            </button>
            <button
                    class="btn"
                    @click="show(false, true, false)">Adaptive
            </button>
            <button
                    class="btn"
                    @click="show(false, false, true)">Draggable
            </button>
            <br>
            <button
                    class="btn green"
